...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Target_t, stringdata0) + ofs), len 
...
const QMetaObject Target::staticMetaObject = { {
    ...
    qt_meta_stringdata_Target.offsetsAndSize,
    qt_meta_data_Target,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Target_t
