...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_myPoint_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_myPoint_t qt_meta_stringdata_myPoint = {
    {
QT_MOC_LITERAL(0, 7), // "myPoint"
QT_MOC_LITERAL(8, 7), // "signal1"
QT_MOC_LITERAL(16, 0) // ""
...
void myPoint::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<myPoint *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (myPoint::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myPoint::signal1)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject myPoint::staticMetaObject = { {
    ...
    qt_meta_stringdata_myPoint.offsetsAndSize,
    qt_meta_data_myPoint,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_myPoint_t
, QtPrivate::TypeAndForceComplete<myPoint, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
